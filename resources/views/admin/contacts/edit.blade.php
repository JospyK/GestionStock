    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contacts.update", [$contact->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference') ? 'is-invalid' : '' }}" type="text" name="reference" id="reference" value="{{ old('reference', $contact->reference) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('raison_sociale') ? 'is-invalid' : '' }}" type="text" name="raison_sociale" id="raison_sociale" value="{{ old('raison_sociale', $contact->raison_sociale) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telephone_1') ? 'is-invalid' : '' }}" type="text" name="telephone_1" id="telephone_1" value="{{ old('telephone_1', $contact->telephone_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telephone_2') ? 'is-invalid' : '' }}" type="text" name="telephone_2" id="telephone_2" value="{{ old('telephone_2', $contact->telephone_2) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('adresse') ? 'is-invalid' : '' }}" name="adresse" id="adresse">{{ old('adresse', $contact->adresse) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('client') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="client" id="client" value="1" {{ $contact->client || old('client', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('fournisseur') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="fournisseur" id="fournisseur" value="1" {{ $contact->fournisseur || old('fournisseur', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <label for="created_by_id">{{ trans('cruds.contact.fields.created_by') }}</label>
                <select class="form-control select2 {{ $errors->has('created_by') ? 'is-invalid' : '' }}" name="created_by_id" id="created_by_id">
                    @foreach($created_bies as $id => $entry)
                        <option value="{{ $id }}" {{ (old('created_by_id') ? old('created_by_id') : $contact->created_by->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.contact.fields.created_by_helper') }}</span>
            </div>
            <div class="form-group">
