    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.articles.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prix_min') ? 'is-invalid' : '' }}" type="number" name="prix_min" id="prix_min" value="{{ old('prix_min', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prix_ht') ? 'is-invalid' : '' }}" type="number" name="prix_ht" id="prix_ht" value="{{ old('prix_ht', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prix_ttc') ? 'is-invalid' : '' }}" type="number" name="prix_ttc" id="prix_ttc" value="{{ old('prix_ttc', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock_actuel') ? 'is-invalid' : '' }}" type="number" name="stock_actuel" id="stock_actuel" value="{{ old('stock_actuel', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock_seuil') ? 'is-invalid' : '' }}" type="number" name="stock_seuil" id="stock_seuil" value="{{ old('stock_seuil', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock_virtuel') ? 'is-invalid' : '' }}" type="number" name="stock_virtuel" id="stock_virtuel" value="{{ old('stock_virtuel', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stock_physique') ? 'is-invalid' : '' }}" type="number" name="stock_physique" id="stock_physique" value="{{ old('stock_physique', '0') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tosell') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tosell" id="tosell" value="1" {{ old('tosell', 0) == 1 || old('tosell') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tobuy') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tobuy" id="tobuy" value="1" {{ old('tobuy', 0) == 1 || old('tobuy') === null ? 'checked' : '' }}>
